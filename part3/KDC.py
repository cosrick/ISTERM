...
def produceKDCMessage(randomInfo, key, recvKey):
...
IPLIST = {'127.0.0.2': ['127.0.0.1',serverPublicKey], '127.0.0.1': ['127.0.0.1',clientPublicKey]}
...
while True:
    ...
    if adr[0] in IPLIST.keys():
        ...
        if request == 'client':
            KDCresponse = produceKDCMessage(T1, IPLIST['127.0.0.1'][1], IPLIST['127.0.0.2'][1])
        elif request == 'server':
            KDCresponse = produceKDCMessage(T1, IPLIST['127.0.0.2'][1], IPLIST['127.0.0.1'][1])
